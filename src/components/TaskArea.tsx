  ...
  return (
    <div className="flex flex-col w-full h-[90vh] overflow-auto p-3">
      ...
      <div className=" w-full p-5 mb-6">
        ...
        <div className={`w-full ${theme === 'light' ? 'bg-[#ffffff]' : 'bg-[#1B1B1B]'} py-3  pt-6 gap-24 space-y-8 flex-col`}>
          <input type="text" value={newTask} onChange={(e) => setNewTask(e.target.value)} placeholder="todo..."   className={`w-full h-4 p-5 ${theme === 'light' ? 'bg-[#ffffff]' : 'bg-[#1B1B1B]'} `}/>
